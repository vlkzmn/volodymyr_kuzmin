        ...
        <div className="contact__wrapper">
          ...
          <div className="contact__content">
            <div className="contact__data">
              <a href="tel:+380633485206" className="contact__data-link contact__data-link--phone">
                +38 063 3485206
              </a>

              <a href="mailto:vlkzmn@gmail.com" className="contact__data-link contact__data-link--email">
                vlkzmn@gmail.com
              </a>
            </div>
